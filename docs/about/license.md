...
MOSE is free and open-source software licensed under the GNU General Public License v3.0 (GPL-3.0).

## Quick Summary

!!! info "License at a Glance"
    - ✅ **Use** - Use MOSE for any purpose
    - ✅ **Modify** - Change the source code as needed
    - ✅ **Distribute** - Share MOSE with others
...
- **Download and use** MOSE without restrictions
- **Use MOSE in research**, including published work
- **Use MOSE commercially** in your business or organization
- **Modify MOSE** to suit your needs

### As a Distributor

If you distribute MOSE (modified or unmodified):
...
By contributing to MOSE:

- You grant MOSE permission to use your contributions
...
MOSE (GPL-3.0) is compatible with:
...
!!! warning "License Compatibility"
    When combining MOSE with other software, ensure all licenses are compatible.

## Dependencies and Their Licenses

MOSE uses several dependencies, each with its own license:

| Dependency | License | Compatibility |
|------------|---------|---------------|
| **FLINT** | GPL v3.0 | ✅ Same license |
| **ORION** | GPL v3.0 | ✅ Same license |
| **OSlo** | GPL v3.0 | ✅ Same license |
| **FiNeR** | GPL v3.0 | ✅ Same license |
...
- **In the repository:** [LICENSE](https://github.com/open-hydra/MOSE/blob/main/LICENSE) file
- **Online:** [gnu.org/licenses/gpl-3.0.html](https://www.gnu.org/licenses/gpl-3.0.html)

## Warranty Disclaimer

!!! warning "No Warranty"
    MOSE is provided "as is" without warranty of any kind, either expressed or implied. See the full license for complete warranty disclaimer.
